              ...
              <div className="space-y-6">
                <div className="text-center">
                  <div className="flex items-center justify-center gap-2 mb-4">
                    ...
                    <span className="text-xl text-muted-foreground">/ business</span>
                  </div>
                  <Badge variant="outline" className="text-lg px-4 py-2 mb-6 border-blue-500 text-blue-600">
                    Entry Price
                  </Badge>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-blue-50 rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">1–2 hours session</p>
                  </div>
                  
                  <div className="bg-purple-50 rounded-lg p-4 text-center">
                    <div className="flex items-center justify-center gap-2 mb-2">
                      <FileText className="w-5 h-5 text-purple-600" />
                      <span className="font-semibold text-purple-600">Report</span>
                    </div>
                    <p className="text-sm text-muted-foreground">4 days delivery</p>
                  </div>
                </div>

                <div className="text-center pt-6">
                  <Button variant="gradient" size="lg" className="text-lg px-8 py-6 w-full sm:w-auto bg-gradient-to-r from-blue-600 to-purple-600">
