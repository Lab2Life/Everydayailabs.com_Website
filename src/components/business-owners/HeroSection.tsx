      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            <span className="font-semibold text-green-600">Let AI handle the load, while you focus on growth.</span>
            <br className="hidden md:block" />
            AI isn't about replacing people. It's about giving you back time, clarity, and control.
          </p>
          
          {/* Description */}
          <p className="text-lg text-muted-foreground mb-12 max-w-2xl mx-auto">
            A practical program that shows business owners how to use AI as a daily assistant, not a distant tech. 
            It's about simplifying decisions, saving time, and multiplying your business impact.
          </p>
          
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button size="lg" className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-8 py-6 text-lg group">
              Transform Your Business
              <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
            </Button>
            <Button variant="outline" size="lg" className="px-8 py-6 text-lg border-green-200 hover:bg-green-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 pt-8 border-t border-green-100">
            <div className="text-center">
              <div className="text-3xl font-bold text-green-600 mb-2">2-3 Hours</div>
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-emerald-600 mb-2">Growth Focus</div>
