  ...
  const features = [
    {
      ...
      description: "Simple, practical solutions that work with your existing business operations and mindset."
    },
    {
      icon: Users,
      title: "Not About Complex Tools",
      description: "Straightforward AI applications that integrate seamlessly into your daily workflow."
    },
    {
      icon: Zap,
      title: "Daily Assistant Partnership",
      description: "AI becomes your reliable business partner for decisions, operations, and growth planning."
    }
  ];
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              A <span className="font-semibold text-green-600">practical program</span> that shows business owners how to use AI as a daily assistant, not a distant tech.
              <br />
              It's about <span className="font-semibold text-green-600">simplifying decisions, saving time, and multiplying your business impact.</span>
            </p>
          </div>
