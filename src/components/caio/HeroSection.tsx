...
const HeroSection = () => {
  const scrollToWhatIsCAIO = () => {
    const whatIsElement = document.querySelector("#what-is-caio");
    if (whatIsElement) {
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
          ...
          <div className="flex justify-center">
            <Button
              variant="gradient"
              size="xl"
              className="bg-gradient-to-r from-purple-600 to-blue-600 group"
              onClick={scrollToWhatIsCAIO}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12 border-t border-border/50">
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground">
                Foundation → Practitioner → Strategist
              </div>
            </div>
            <div className="text-center">
