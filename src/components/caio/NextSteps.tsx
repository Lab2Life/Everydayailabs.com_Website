...
import { ArrowRight, Phone, Globe, Award } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready to become a <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Certified AI Officer?</span>
          </h2>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-blue-50 border-2 border-purple-200 rounded-2xl p-8 md:p-12 shadow-elegant">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
                Begin the journey and make \"Certified AI Officer\" your next career milestone
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <Button variant="gradient" size="xl" className="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 group">
                  Start CAIO Foundation Level
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12 animate-fade-in">
          <div className="bg-card border border-border rounded-xl p-6 shadow-card text-center">
            ...
            <p className="text-muted-foreground text-sm">Master AI tools for daily tasks</p>
          </div>
          ...
          <div className="bg-card border border-border rounded-xl p-6 shadow-card text-center">
            ...
            <p className="text-muted-foreground text-sm">Apply AI across workflows</p>
          </div>
          ...
          <div className="bg-card border border-border rounded-xl p-6 shadow-card text-center">
            ...
            <p className="text-muted-foreground text-sm">Lead AI adoption strategy</p>
          </div>
        </div>
      </div>
    </section>
