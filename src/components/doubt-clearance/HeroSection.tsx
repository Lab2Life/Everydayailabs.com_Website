    ...
    <section className="bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <Badge variant="outline" className="mb-6 text-lg px-4 py-2 border-orange-500 text-orange-600">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button variant="gradient" size="lg" className="text-lg px-8 py-6 bg-gradient-to-r from-orange-600 to-amber-600">
              Clear Your AI Doubts
            </Button>
            <Button variant="outline" size="lg" className="text-lg px-8 py-6 border-orange-500 text-orange-600">
              Learn More
            </Button>
          </div>
        </div>
