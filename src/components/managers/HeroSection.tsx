...
const HeroSection = () => {
  const scrollToWhatIs = () => {
    const whatIsElement = document.querySelector("#what-is-managers");
    if (whatIsElement) {
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            <span className="font-semibold text-amber-600">
              Let AI handle the routines for you.
            </span>
          ...
          <div className="flex justify-center">
            <Button
              size="lg"
              className="bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white px-8 py-6 text-lg group"
