      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            <span className="font-semibold text-emerald-600">Learn how to save time, money, and effort</span> — every single day.
          </p>
          
          {/* Description */}
          <p className="text-lg text-muted-foreground mb-12 max-w-2xl mx-auto">
            A 2-hour practical group session that transforms AI from confusing tech-talk 
            into simple, everyday tools you can use immediately.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button variant="outline" size="lg" className="px-8 py-6 text-lg border-emerald-200 hover:bg-emerald-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 pt-8 border-t border-emerald-100">
            <div className="text-center">
              <div className="text-3xl font-bold text-emerald-600 mb-2">2 Hours</div>
              <div className="text-muted-foreground">From confusion to confidence</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-teal-600 mb-2">10+ Tools</div>
              <div className="text-muted-foreground">Practical daily applications</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-cyan-600 mb-2">Save 2 Hours</div>
