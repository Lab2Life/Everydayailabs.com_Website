        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-12">
            ...
            <p className="text-xl text-emerald-100 mb-8 max-w-3xl mx-auto">
              One decision today gives you <span className="text-green-300">clarity and confidence in AI for life</span>.
            </p>
          ...
          <Card className="bg-white/10 backdrop-blur-sm border-white/20 mb-12">
            <CardContent className="p-8">
              <div className="flex items-center justify-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold">Join the AI-Confident Community</h3>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            <div className="flex items-center justify-center gap-3 p-4 bg-white/5 rounded-lg">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-emerald-200">EverydayAiLabs.com</p>
              </div>
            </div>
            <div className="flex items-center justify-center gap-3 p-4 bg-white/5 rounded-lg">
          ...
          <div className="mt-12 pt-8 border-t border-white/20">
            <p className="text-emerald-200 text-lg font-medium">
              The AI wave is here. You can either ride it or be swept away by it.
            </p>
