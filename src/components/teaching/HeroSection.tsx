        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            <span className="font-semibold text-blue-600">
              Let AI handle routine prep, while you focus on inspiring and
              guiding students.
            </span>
            <br className="hidden md:block" />
            AI isn't about replacing educators. It's about giving you back time,
            clarity, and impact.
          </p>

          <p className="text-lg text-muted-foreground mb-12 max-w-2xl mx-auto">
            A practical program showing educators how to use AI as a daily
            teaching assistant. No coding. No complex systems. Just better
            teaching through smart automation.
          </p>
