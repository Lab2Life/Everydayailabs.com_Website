      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready for <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">365 days</span> of automated success?
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            One decision today gives you 365 days of consistent, stress-free WhatsApp communication
          </p>
        </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-8 md:p-12 shadow-elegant">
            <div className="text-center mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <Button variant="gradient" size="xl" className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 group">
                  Start WA365 Setup
            ...
            <div className="border-t border-green-200 pt-8 text-center">
              <p className="text-lg font-medium text-gray-700 mb-4">
                "This is just one way AI can help. If you ever wonder, 'Can AI solve my problem?', think of EverydayAiLabs.com first."
              </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12 animate-fade-in">
          <div className="bg-card border border-border rounded-xl p-6 shadow-card text-center">
            ...
            <p className="text-muted-foreground text-sm">20-minute business workflow analysis</p>
          </div>
          ...
          <div className="bg-card border border-border rounded-xl p-6 shadow-card text-center">
            ...
            <p className="text-muted-foreground text-sm">Custom WhatsApp workflows deployed</p>
          </div>
          ...
          <div className="bg-card border border-border rounded-xl p-6 shadow-card text-center">
            ...
            <p className="text-muted-foreground text-sm">365 days of automated reliability</p>
          </div>
        </div>
        
        <div className="text-center mt-12 animate-fade-in">
          <div className="bg-card border border-border rounded-xl p-6 shadow-card max-w-2xl mx-auto">
            <h4 className="text-lg font-semibold mb-2 text-green-600">Why Choose WA365 Today?</h4>
            <p className="text-muted-foreground">
              Every day without automation means missed opportunities, inconsistent communication, 
              and customers moving to more organized competitors.
            </p>
          </div>
        </div>
      </div>
