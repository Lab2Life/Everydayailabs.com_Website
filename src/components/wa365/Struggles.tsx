      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Struggles <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">Business Owners</span> Face
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            WhatsApp communication gaps are costing businesses customers, credibility, and countless hours every day
          </p>
        </div>
        ...
        <div className="text-center mt-16 animate-fade-in">
          <div className="bg-gradient-to-br from-red-50 to-orange-50 border-2 border-red-200 rounded-xl p-8 shadow-card max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Every missed message, delayed follow-up, and inconsistent communication pushes your customers 
              toward competitors who have automated, professional WhatsApp systems.
            </p>
          </div>
        </div>
      </div>
