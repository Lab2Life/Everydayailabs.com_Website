...
const WhatIsWA365 = () => {
  return (
    <section id="what-is-wa365" className="py-20 bg-gradient-subtle">
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="bg-card border border-border rounded-xl p-6 shadow-card">
              ...
              <p className="text-muted-foreground leading-relaxed">
                From daily updates to advanced workflows, WA365 ensures your
                business never misses a customer or a task.
              </p>
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6 shadow-card">
              ...
              <p className="text-muted-foreground leading-relaxed">
                It's not just automation. It's business survival on the channel
            ...
            <div className="bg-card border border-border rounded-xl p-6 shadow-card">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Your reliable communication backbone that works 24/7, ensuring
                every customer interaction strengthens your brand.
              </p>
            </div>
          </div>
