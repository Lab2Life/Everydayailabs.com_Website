...
import { ArrowRight, Pen, Image, Video, Mic, Sparkles, Globe, Phone } from "lucide-react";
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                <span className="font-semibold text-rose-600">Let AI spark your creativity and handle the heavy lifting while you focus on storytelling.</span>
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Button size="lg" className="bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-700 hover:to-pink-700 text-white px-8 py-6 text-lg group">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-muted-foreground">"Ideate → Create → Optimize"</p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  { icon: Pen, title: "AI for Writing", description: "Generate articles, scripts, and copy in any style or tone." },
                  { icon: Image, title: "AI for Visual Content", description: "Create stunning graphics, illustrations, and designs." },
                  { icon: Video, title: "AI for Video Production", description: "Edit, enhance, and generate video content efficiently." },
                  { icon: Mic, title: "AI for Audio Content", description: "Podcasts, voiceovers, and music creation made simple." },
                  { icon: Sparkles, title: "AI for Content Strategy", description: "Data-driven content planning and optimization." }
                ].map((item, index) => {
                  ...
                  return (
                    <Card key={index} className="hover:shadow-lg transition-all duration-300">
                      <CardContent className="p-6">
                        ...
                        <h3 className="text-xl font-semibold mb-3 text-rose-600">{item.title}</h3>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg border border-pink-200">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  We understand the creative process. Our AI training focuses on <span className="font-semibold text-pink-600">enhancing creativity, not replacing it</span> - 
                  helping you produce more while maintaining your unique voice.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-rose-100 mb-8">
                Stop struggling with creative block. Start creating consistently amazing content with AI as your creative partner.
              </p>
              
              <Button size="lg" className="bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white px-8 py-6 text-lg group mb-12">
              ...
              <div className="mt-12 pt-8 border-t border-white/20">
                <p className="text-rose-200 text-lg">
                  Your audience deserves amazing content. Give AI the tools, keep the creative vision.
                </p>
              </div>
            </div>
          </div>
