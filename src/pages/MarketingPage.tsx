...
import { ArrowRight, Target, TrendingUp, Zap, BarChart, Users, Globe, Phone } from "lucide-react";
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                <span className="font-semibold text-emerald-600">Let AI handle the repetitive tasks while you focus on strategy and creativity.</span>
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-muted-foreground">"Automate → Analyze → Optimize"</p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  { icon: Zap, title: "AI for Content Creation", description: "Generate copy, visuals, and campaign ideas in minutes." },
                  { icon: Target, title: "AI for Audience Targeting", description: "Smart segmentation and personalized messaging." },
                  { icon: BarChart, title: "AI for Analytics", description: "Real-time insights and performance optimization." },
                  { icon: TrendingUp, title: "AI for Trend Analysis", description: "Stay ahead with predictive marketing intelligence." },
                  { icon: Users, title: "AI for Customer Journey", description: "Map and optimize every touchpoint automatically." }
                ].map((item, index) => {
                  ...
                  return (
                    <Card key={index} className="hover:shadow-lg transition-all duration-300">
                      <CardContent className="p-6">
                        ...
                        <h3 className="text-xl font-semibold mb-3 text-emerald-600">{item.title}</h3>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg border border-teal-200">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  We don't just teach AI tools - we show you how to <span className="font-semibold text-teal-600">integrate AI into your entire marketing workflow</span> 
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-emerald-100 mb-8">
                Stop drowning in campaign tasks. Start leading with AI-powered marketing strategies.
              </p>
              
              <Button size="lg" className="bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white px-8 py-6 text-lg group mb-12">
