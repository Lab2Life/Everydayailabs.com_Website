            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                <span className="font-semibold text-violet-600">
                  Let AI qualify leads, craft proposals, and track opportunities
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 text-white px-8 py-6 text-lg group"
                >
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  {
                    icon: Users,
                    title: "AI for Lead Qualification",
                    description:
                      "Automatically score and prioritize prospects.",
                  },
                  {
                    icon: MessageSquare,
                    title: "AI for Outreach",
                    description: "Personalized emails and proposals at scale.",
                  },
                  {
                    icon: BarChart,
                    title: "AI for Pipeline Management",
                    description: "Smart forecasting and opportunity tracking.",
                  },
                  {
                    icon: TrendingUp,
                    title: "AI for Performance Analysis",
                    description:
                      "Identify winning patterns and optimize strategies.",
                  },
                  {
                    icon: Trophy,
                    title: "AI for Deal Intelligence",
                    description: "Real-time insights for closing bigger deals.",
                  },
                ].map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      <CardContent className="p-6">
                        ...
                        <h3 className="text-xl font-semibold mb-3 text-violet-600">
                          {item.title}
                        </h3>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg border border-purple-200">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  ...
                  <span className="font-semibold text-purple-600">
                    sales-specific AI applications
                  </span>{" "}
                  that directly impact your numbers - from lead generation to
                  deal closure.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-violet-100 mb-8">
                Stop chasing leads manually. Start closing deals with AI-powered
                sales intelligence.
              </p>

              <Button
                size="lg"
                className="bg-gradient-to-r from-violet-500 to-purple-500 hover:from-violet-600 hover:to-purple-600 text-white px-8 py-6 text-lg group mb-12"
              >
              ...
              <div className="mt-12 pt-8 border-t border-white/20">
                <p className="text-violet-200 text-lg">
                  Every deal you miss is revenue lost. Make AI your competitive
                  advantage.
                </p>
              </div>
            </div>
