...
import { ArrowRight, Heart, Smartphone, Shield, Users, Home, Globe, Phone } from "lucide-react";
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                <span className="font-semibold text-blue-600">Make technology work for you, not against you. AI made simple, safe, and useful.</span>
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-muted-foreground">"Simple → Safe → Useful"</p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  { icon: Smartphone, title: "AI for Daily Tasks", description: "Voice assistants, photo organization, and simple automation." },
                  { icon: Shield, title: "AI for Safety", description: "Scam detection, secure browsing, and privacy protection." },
                  { icon: Users, title: "AI for Connection", description: "Video calls, messaging, and staying connected with family." },
                  { icon: Heart, title: "AI for Health", description: "Medication reminders, health tracking, and wellness support." },
                  { icon: Home, title: "AI for Home", description: "Smart home basics, entertainment, and convenience features." }
                ].map((item, index) => {
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg border border-indigo-200">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  We understand that seniors need technology to be <span className="font-semibold text-indigo-600">gentle, patient, and practical</span>. 
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-blue-100 mb-8">
                You deserve to feel confident with technology. Let us show you how AI can make your life easier, not harder.
              </p>
              ...
              <div className="mt-12 pt-8 border-t border-white/20">
                <p className="text-blue-200 text-lg">
                  Technology should serve you, not stress you. Take the first step towards digital confidence.
                </p>
              </div>
            </div>
          </div>
