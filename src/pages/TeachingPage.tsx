            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                <span className="font-semibold text-blue-600">
                  Let AI handle routine prep, while you focus on inspiring
                  students.
                </span>
              </p>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  {
                    icon: BookOpen,
                    title: "AI for Lesson Prep",
                    description:
                      "Generate content, quizzes, and teaching materials in minutes.",
                  },
                  {
                    icon: MessageSquare,
                    title: "AI for Feedback",
                    description:
                      "Grade assignments and provide personalized comments quickly.",
                  },
                  {
                    icon: Users,
                    title: "AI for Engagement",
                    description:
                      "Create interactive exercises and discussion prompts effortlessly.",
                  },
                  {
                    icon: BarChart,
                    title: "AI for Insight",
                    description:
                      "Analyze student performance and learning gaps instantly.",
                  },
                  {
                    icon: Settings,
                    title: "AI for Admin",
                    description:
                      "Manage tasks and focus on high-impact teaching.",
                  },
                ].map((item, index) => {
